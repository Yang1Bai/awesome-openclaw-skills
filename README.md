...
**Awesome OpenClaw Skills** 是一个精选的 OpenClaw 技能合集，收录了来自官方 OpenClaw 技能注册表的 **5,400+ 个技能**，经过筛选和分类整理。

### 什么是 OpenClaw 技能？

OpenClaw 技能（Skills）是可插拔的专项指令模块，赋予 AI 助手特定领域的专业能力——从代码开发、文档写作到科研分析、自动化工作流，一键激活即用。

### 如何使用

1. 浏览分类目录，找到你需要的技能
2. 将技能安装到你的 OpenClaw 配置中
3. 在对话中直接调用，AI 会按技能指令执行

### 🌐 在线目录

访问 [clawskills.sh](https://clawskills.sh/) 查看完整可搜索目录。

### 贡献

欢迎提交 PR 添加新技能！请确保技能有清晰的描述和使用场景说明。
